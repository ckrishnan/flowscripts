...
(function () {
  ...
  var doc = this.getField("Casestatus").value;
  var plratio = getField("Plasma cell K/L").value;
    ...
    // Typical CLL - marrow
    aFlowInt[50] = "Flow cytometry was performed on the bone marrow to evaluate for evidence of an abnormal lymphoid population. The lymphoid gate (CD45+, low SSC/FSC) shows a "+bclone+"-restricted population of CD19+ B-cells expressing CD5, CD20 (dim), CD200 (bright), but not CD10, CD103, or FMC-7. CD38 expression is ____. Surface immunoglobulin expression is moderate-to-dim in intensity [#OR Surface immunoglobulin expression is moderate-to-dim in intensity and best seen when using polyclonal light-chain reagents]. Overall, this population represents approximately __% of all CD45+ events. The remainder of lymphoid events corresponds to a mixed population of CD4 and CD8 T-cells, which do not show antigenic aberrancies. \n\nThe monocyte/large lymphocyte gate (CD45+, moderate SSC/FSC) shows predominantly CD33 bright cells consistent with monocytes. Monocytes do not show aberrant antigen expression. \n\nMost analyzed events are maturing granulocytes which show high side-scatter and no aberrancies of analyzed antigens. Gating on blasts (mod CD45+/low SSC) shows few CD34+ myeloid progenitors accounting for __% of total events. \n\nThere is a CD5+ clonal B-cell population with an immunophenotype most consistent with chronic lymphocytic leukemia. Mantle cell lymphoma can sometimes show a similar phenotype. Correlation with the morphologic findings and any pending ancillary studies is recommended. \n\nInterpreted by "+doc+", M.D.";
    
    // Typical CLL - tissue
    aFlowInt[51] = "Flow cytometry was performed to evaluate for evidence of an abnormal lymphoid population. The lymphoid gate (CD45+, low SSC/FSC) shows a "+bclone+"-restricted population of CD19+ B-cells expressing CD5, CD20 (dim), CD200 (bright), but not CD10, CD103, or FMC-7. CD49d expression is [## negative (ie. <30% of abnormal cells express this marker) OR is positive (ie. >30% of abnormal cells express this marker) ##]. Surface immunoglobulin expression is moderate-to-dim in intensity [#OR Surface immunoglobulin expression is moderate-to-dim in intensity and best seen when using polyclonal light-chain reagents]. Overall, this population represents approximately __% of all CD45+ events. The remainder of lymphoid events corresponds to a mixed population of CD4 and CD8 T-cells, which do not show antigenic aberrancies. \n\nThere is a CD5+ clonal B-cell population with an immunophenotype most consistent with chronic lymphocytic leukemia. Mantle cell lymphoma can sometimes show a similar phenotype. Correlation with the morphologic findings and any pending ancillary studies is recommended. \n\nInterpreted by "+doc+", M.D.";
